<div class="container-fluid">
    ...
    <div class="row">
                    ...
                    <form wire:submit.prevent="save">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select wire:model.live="mata_kuliah_id" id="mata_kuliah_id" class="form-control @error('mata_kuliah_id') is-invalid @enderror">
                            ...
                            @if($isAdmin)
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select wire:model.live="dosen_id" id="dosen_id" class="form-control @error('dosen_id') is-invalid @enderror">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select wire:model.live="periode_id" id="periode_id" class="form-control @error('periode_id') is-invalid @enderror">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" wire:model="file" id="file" class="form-control @error('file') is-invalid @enderror" accept=".pdf,.doc,.docx">
        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-{{ $isAdmin ? 'danger' : 'success' }}">
